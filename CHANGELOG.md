...
-   ![(tick)](docs/images/check.svg) Fixed: [java.io](http://java.io).NotSerializableException:
    ...
    channel ([JENKINS-57244](https://issues.jenkins.io/browse/JENKINS-57244))
-   ![(tick)](docs/images/check.svg) Fixed: Upgrade maven embedder from 3.1.0 to at least
    3.5.4 ([JENKINS-54530](https://issues.jenkins.io/browse/JENKINS-54530)

### Version 3.2 (November 30, 2018)

-   ![(tick)](docs/images/check.svg) Fixed: remove anonymous classes
    ([JENKINS-53481](https://issues.jenkins.io/browse/JENKINS-53481)

### Version 3.1.2 (March 27, 2018)

-   ![(tick)](docs/images/check.svg) Fixed: JEP-200 failure to serialize Notifier, used
    when \<ciManagement\> specifies email configuration. ([JENKINS-50251](https://issues.jenkins.io/browse/JENKINS-50251) -
...
-   ![(tick)](docs/images/check.svg) Fixed: UnsupportedOperationException: Refusing to
    ...
    for security reasons ( [JENKINS-49089](https://issues.jenkins.io/browse/JENKINS-49089) -
    Getting issue details... STATUS  )
-   ![(tick)](docs/images/check.svg) Fixed: Forbid nested references to model objects ( 
    [JENKINS-45892](https://issues.jenkins.io/browse/JENKINS-45892) -
    Getting issue details... STATUS  )
...
-   ![(tick)](docs/images/check.svg)
    ...
    projects ([JENKINS-13277](https://issues.jenkins.io/browse/JENKINS-13277)
-   ![(tick)](docs/images/check.svg)
     Fixed: Allow to automatically trigger jobs when a
    project import the dependencyManagement of another
    ([JENKINS-15883](https://issues.jenkins.io/browse/JENKINS-15883)
-   ![(info)](docs/images/information.svg)
     Internal: Update HttpClient and use the
    client from [Apache HttpComponents Client 4.x API Plugin](https://wiki.jenkins.io/display/JENKINS/Apache+HttpComponents+Client+4.x+API+Plugin) ([JENKINS-46053](https://issues.jenkins.io/browse/JENKINS-46053),
    [JENKINS-46210](https://issues.jenkins.io/browse/JENKINS-46210)
-   ![(info)](docs/images/information.svg)
    Internal: Use the JSch library from the [JSch Plugin](https://wiki.jenkins.io/display/JENKINS/JSch+Plugin)
-   ![(info)](docs/images/information.svg)
     Internal: Fix Parent
    POM ([JENKINS-45271](https://issues.jenkins.io/browse/JENKINS-45271)
-   ![(info)](docs/images/information.svg)
     Internal: Maven Plugin uses obsolete maven
    methods
    ([JENKINS-46148](https://issues.jenkins.io/browse/JENKINS-46148)  
-   ![(tick)](docs/images/check.svg)
...
-   ![(tick)](docs/images/check.svg)
    ...
    -   [JENKINS-42549](https://issues.jenkins.io/browse/JENKINS-42549) -
    ...
    -   [JENKINS-40621](https://issues.jenkins.io/browse/JENKINS-40621) -
...
-   ![(tick)](docs/images/check.svg)
    ...
    [JENKINS-43446](https://issues.jenkins.io/browse/JENKINS-43446))
-   ![(tick)](docs/images/check.svg)
     Fixed: fix typo in image sources
    ([JENKINS-42833](https://issues.jenkins.io/browse/JENKINS-42833))
...
-   ![(tick)](docs/images/check.svg)
    ...
    [JENKINS-41636](https://issues.jenkins.io/browse/JENKINS-41636),
    SECURITY-382 )
-   ![(tick)](docs/images/check.svg)
...
-   ![(tick)](docs/images/check.svg)
    ...
    [JENKINS-41761](https://issues.jenkins.io/browse/JENKINS-41761)
    )
-   ![(tick)](docs/images/check.svg)
     Fixed: StackOverflowError when parsing Maven POM (
    [JENKINS-41697](https://issues.jenkins.io/browse/JENKINS-41697),
    [JENKINS-42183](https://issues.jenkins.io/browse/JENKINS-42183)
...
-   ![(info)](docs/images/information.svg)
    ...
    [JENKINS-38960](https://issues.jenkins.io/browse/JENKINS-38960)
    )
-   ![(info)](docs/images/information.svg)
     Internal: Fix tests for Jenkins 2, use a
    minimum set of permalinks instead of a fixed set (
    [JENKINS-40949](https://issues.jenkins.io/browse/JENKINS-40949)
    )
-   ![(info)](docs/images/information.svg)
    ...
    -   Update Apache Wagon `2.4` to `2.12` which solves various issues
        (like SNI support -
        [JENKINS-40903](https://issues.jenkins.io/browse/JENKINS-40903),
        [JENKINS-38738](https://issues.jenkins.io/browse/JENKINS-38738)
...
-   ![(tick)](docs/images/check.svg)
    ...
    as Aborted ([JENKINS-24832](https://issues.jenkins.io/browse/JENKINS-24832))
-   ![(tick)](docs/images/check.svg)
     Fixed: Apache Maven 3.3 support and toolchains
    integration (
    [JENKINS-28629](https://issues.jenkins.io/browse/JENKINS-28629),
    [JENKINS-28420](https://issues.jenkins.io/browse/JENKINS-28420)
    )
-   ![(tick)](docs/images/check.svg)
     Fixed: Option "Schedule build when some upstream has
    no successful builds" is never saved (
    [JENKINS-37937](https://issues.jenkins.io/browse/JENKINS-37937)
    )
-   ![(tick)](docs/images/check.svg)
     Fixed: With Jenkins 2.x Maven configuration screen
    is linking to the wrong configuration page when you have no maven
    installation configured (
    [JENKINS-38923](https://issues.jenkins.io/browse/JENKINS-38923),
    [JENKINS-36068](https://issues.jenkins.io/browse/JENKINS-36068),
    [JENKINS-34743](https://issues.jenkins.io/browse/JENKINS-34743)
    )
-   ![(tick)](docs/images/check.svg)
     Fixed: Release builds should not trigger downstream
    projects ([JENKINS-34789](https://issues.jenkins.io/browse/JENKINS-34789))
-   ![(tick)](docs/images/check.svg)
     Fixed: Redeploy publisher must reuse global maven
    settings from the slave (
    [JENKINS-27161](https://issues.jenkins.io/browse/JENKINS-27161)
    )
-   ![(tick)](docs/images/check.svg)
...
-   ![(info)](docs/images/information.svg)
    ...
    [JENKINS-38736](https://issues.jenkins.io/browse/JENKINS-38736)
    )

### Version 2.13 (May 19, 2016)

-   [JENKINS-31162](https://issues.jenkins.io/browse/JENKINS-31162)
    New item categorization and dynamic choice offering
-   [JENKINS-33387](https://issues.jenkins.io/browse/JENKINS-33387)
    Transient actions aren't displayed in Maven Jobs
-   [JENKINS-31258](https://issues.jenkins.io/browse/JENKINS-31258)
    Jenkins Maven plug-in ignores JUnit-format test results from unknown
    Maven plug-ins
-   [JENKINS-31524](https://issues.jenkins.io/browse/JENKINS-31524)
...
-   [JENKINS-28147](https://issues.jenkins.io/browse/JENKINS-28147)
    Perform Environment tearDown if BuildWrapper fails
-   [JENKINS-7010](https://issues.jenkins.io/browse/JENKINS-7010)
    Maven settings configured at Maven job level aren't used inside the
    promotion step
-   [JENKINS-4428](https://issues.jenkins.io/browse/JENKINS-4428)
    MavenProbeAction exposes password parameters
-   [JENKINS-32635](https://issues.jenkins.io/browse/JENKINS-32635)
...
-   [JENKINS-22252](https://issues.jenkins.io/browse/JENKINS-22252)
    Reverting fix for
    [JENKINS-26947](https://issues.jenkins.io/browse/JENKINS-26947)
...
-   [JENKINS-26947](https://issues.jenkins.io/browse/JENKINS-26947)
    ...
    closed.
-   [JENKINS-21746](https://issues.jenkins.io/browse/JENKINS-21746)
...
-   [JENKINS-25272](https://issues.jenkins.io/browse/JENKINS-25272)
    Update
    ...
    using JDK 5.
-   [JENKINS-25625](https://issues.jenkins.io/browse/JENKINS-25625)
    Simplified dependencies for development from other plugins.

### Version 2.10 (Jun 08, 2015)

-   [JENKINS-25406](https://issues.jenkins.io/browse/JENKINS-25406)
...
-   [issue#25691](https://issues.jenkins.io/browse/JENKINS-25691) Redeploy
    link is displayed to Anonymous users with read only permissions for
    a job

#### Version 2.7 (Oct 10, 2014)

-   [issue#11964](https://issues.jenkins.io/browse/JENKINS-11964) Cannot
    build a single module in a Maven multi-module job with Maven 3
-   [issue#11078](https://issues.jenkins.io/browse/JENKINS-11078) NullPointerException
    in
    hudson.maven.Maven3Builder$MavenExecutionListener.recordProjectStarted
-   [issue#20884](https://issues.jenkins.io/browse/JENKINS-20884) Variable
    expansion in maven goals
-   [issue#21903](https://issues.jenkins.io/browse/JENKINS-21903) Unless
    ...
    building.
-   [issue#4861](https://issues.jenkins.io/browse/JENKINS-4861) Use
    newer version of transitive plexus-utils dependency that allows to
    correctly deploy artifacts using scpexe.
-   [issue#24282](https://issues.jenkins.io/browse/JENKINS-24282) Use
...
-   [JENKINS-23098](https://issues.jenkins.io/browse/JENKINS-23098)
...
-   [JENKINS-11333](https://issues.jenkins.io/browse/JENKINS-11333)
...
-   [JENKINS-21014](https://issues.jenkins.io/browse/JENKINS-21014)
...
-   Fixed: Sites for nested Maven multi-modules projects deeper than one
    level are archived flat [issue#22673](https://issues.jenkins.io/browse/JENKINS-22673)
-   Fixed: NPE while loading jobs [issue#22647](https://issues.jenkins.io/browse/JENKINS-22647)

#### Version 2.2 (Apr 3 2014)

-   Fixed: significant improvements in the Maven build performance
    [JENKINS-22354](https://issues.jenkins.io/browse/JENKINS-22354)
-   Fixed: NullPointerException during parsing POM
    [JENKINS-21279](https://issues.jenkins.io/browse/JENKINS-21279)
-   Fixed: maven.build.timestamp.format is not obeyed in maven buids
    [JENKINS-9693](https://issues.jenkins.io/browse/JENKINS-9693)
-   New: Expose project actions of pre- and post- builders
    [JENKINS-20506](https://issues.jenkins.io/browse/JENKINS-20506)
...
-   Fixed: don't save per-job MAVEN\_OPTS if they're the same as the
    global ones
    [JENKINS-13926](https://issues.jenkins.io/browse/JENKINS-13926)
-   New: Expose Maven properties (e.g. GAV) as environment variables
    [JENKINS-18272](https://issues.jenkins.io/browse/JENKINS-18272)
-   Fixed: Abort module build when maven build is aborted
    [JENKINS-19801](https://issues.jenkins.io/browse/JENKINS-19801)
-   Fixed: Show aggregated failures same way Matrix build does
    [JENKINS-19884](https://issues.jenkins.io/browse/JENKINS-19884)
-   Fixed: Maven plugin sends email to 'null'
    adress [JENKINS-20209](https://issues.jenkins.io/browse/JENKINS-20209)
-   Fixed: provide better error message if maven\_home isn't set
    [JENKINS-20385](https://issues.jenkins.io/browse/JENKINS-20385)
-   Fixed: call postBuild after module build completion
    [JENKINS-20487](https://issues.jenkins.io/browse/JENKINS-20487)
-   Fixed: Hacks used by MavenMailer to load config.jelly from plain
    Mailer broke in mailer 1.6
    [JENKINS-21045](https://issues.jenkins.io/browse/JENKINS-21045)
...
-   Fixed: no errors logged in Jenkins' console if build failed
    ([JENKINS-19352](https://issues.jenkins.io/browse/JENKINS-19352))
-   Fixed: too verbose logging in Maven builds
    ([JENKINS-19396](https://issues.jenkins.io/browse/JENKINS-19396))
...
-   Fixed: Set the correct status of a maven build, in case that one
    ...
    ([JENKINS-16522](https://issues.jenkins.io/browse/JENKINS-16522))
